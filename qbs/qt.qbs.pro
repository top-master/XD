...
defineReplace(setupProfile) {
    ...
    export(neonFlags)
    qtOpenglIncludeDirs = $$join(QMAKE_INCDIR_OPENGL, "\", \"", "\"", "\"")
    export(qtOpenglIncludeDirs)
    qtOpenglesIncludeDirs = $$join(QMAKE_INCDIR_OPENGL_ES2, "\", \"", "\"", "\"")
    export(qtOpenglesIncludeDirs)
    qtOpenGlLibDirs = $$join(QMAKE_LIBDIR_OPENGL, "\", \"", "\"", "\"")
    export(qtOpenGlLibDirs)
    qtOpenles2LibDirs = $$join(QMAKE_LIBDIR_OPENGL_ES2, "\", \"", "\"", "\"")
    export(qtOpenles2LibDirs)
    qtOpenglLibs = $$join(QMAKE_LIBS_OPENGL, "\", \"", "\"", "\"")
    export(qtOpenglLibs)
    qtOpengles2Libs = $$join(QMAKE_LIBS_OPENGL_ES2, "\", \"", "\"", "\"")
    export(qtOpengles2Libs)
    equals(type, host) {
