...
Module {
        ...
        prepare: {
            ...
            cmd.sourceCode = function() {
                ...
                try {
                    ...
                    var module = product.sync.module;
    ...
    Rule {
        ...
        outputArtifacts: {
            var module = product.sync.module;
            var basePath = FileInfo.joinPaths(project.buildDirectory, product.sync.prefix, module);
            ...
            var classNames = product.sync.classNames;
    ...
    Rule {
        ...
        Artifact {
            filePath: {
                var module = product.sync.module;
                return FileInfo.joinPaths(project.buildDirectory,
                                          product.sync.prefix, module, module);
            }
            fileTags: ["hpp_module", "hpp"]
        }
        prepare: {
            var cmd = new JavaScriptCommand();
            cmd.description = "creating module header " + output.fileName;
            cmd.module = product.sync.module;
            cmd.sourceCode = function() {
                var file = new TextFile(output.filePath, TextFile.WriteOnly);
