// SPDY/3 zlib compression dictionary (1423 bytes), extracted verbatim from
// src/network/access/qspdyprotocolhandler.cpp so the server-dummy SPDY layer
// shares the exact dictionary the Qt client uses. Do not edit by hand.
#ifndef SPDY3_DICTIONARY_H
#define SPDY3_DICTIONARY_H
...
static const int spdyDictionaryLength = 1423;

#endif // SPDY3_DICTIONARY_H
