...
private slots:
    ...
    inline void loadNow_decor_shouldCreateIfNotAlareaySet() const {
        ...
        QScopedPointerBase *base = QScopedPointerBase::get(&d_ptr);
    ...
    inline void replace_decor_shouldDoNothingSinceImmutable_data() {
        ...
        QTest::newRow("Without Global.") << false;
        QTest::newRow("With Global.") << true;
    }
    ...
    inline void replace_decor_shouldDoNothingSinceImmutable() {
        ...
        QObjectPrivate *ptrOtherPrivate;
        {
            ...
            QScopedPointerLazy<QObjectData> &d_ptr = DecorDummy::d_ptr_from(&obj);
            QScopedPointerBase *base = QScopedPointerBase::get(&d_ptr);
            QPointerLazinessResolverField &resolver = QLazinessResolver::fieldCast<QPointerLazinessResolverField>(d_ptr);
            ...
            bool isDeleteAllowed = resolver.replace(
                        &d_ptr, &base->d,
    ...
    inline void decor_shouldCastToDecorateeByMetaCastMemberMethod() {
        // Dummy.
        DecorDummy decor;
