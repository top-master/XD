...
import "../../xml/headers.qbs" as QtXmlHeaders
...
QtModuleProject {
    ...
    ].concat(QtUtils.includesForModule("QtCore-private", project.buildDirectory + '/' + root.simpleName, project.version))
    .concat(QtUtils.includesForModule("QtXml-private", project.buildDirectory + '/' + root.simpleName, project.version))
    ...
    QtHeaders {
        ...
        Group {
            ...
            prefix: project.configPath + "/src/corelib/global/"
            files: [
                "qconfig.h",
                "qfeatures.h",
            ]
    ...
    QtModule {
        ...
        qmakeProject: project.qtbasePrefix + "src/tools/bootstrap/bootstrap.pro"
        qmakeProjectPrefix: "bootstrap/"
        ...
        Export {
            ...
            Properties {
                ...
                cpp.frameworks: [
                    "CoreFoundation",
                    "Foundation"
                ].concat(qbs.targetOS.contains("osx") ? ["CoreServices"] : [])
            }
        }
    }
}
