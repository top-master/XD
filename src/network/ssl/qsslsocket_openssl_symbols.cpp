...
DEFINEFUNC2(long, SSL_CTX_set_timeout, SSL_CTX *a, a, long b, b, return -1, return)
DEFINEFUNC3(int, SSL_CTX_set_session_id_context, SSL_CTX *a, a, const unsigned char *b, b, unsigned int c, c, return 0, return)
#if OPENSSL_VERSION_NUMBER >= 0x10100000L
...
DEFINEFUNC2(int, SSL_use_psk_identity_hint, SSL* ssl, ssl, const char* hint, hint, return -1, return)
#endif
#if OPENSSL_VERSION_NUMBER >= 0x10000000L
...
bool q_resolveOpenSslSymbols()
{
    ...
    RESOLVEFUNC(SSL_CTX_set_timeout)
    RESOLVEFUNC(SSL_CTX_set_session_id_context)
#if OPENSSL_VERSION_NUMBER >= 0x10100000L
    ...
    RESOLVEFUNC(SSL_use_psk_identity_hint)
#endif
