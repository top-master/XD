...
public:
    ...
    explicit inline QPointerLazinessResolver(int flags = 0)
...
class QPointerLazinessResolverField : private QAtomicPointer<QLazinessResolver>
{
    friend class QLazinessResolver;
public:
    inline QPointerLazinessResolverField()
        : QAtomicPointer(&QPointerLazinessResolver::globalNullable)
    {}

    inline explicit QPointerLazinessResolverField(QPointerLazinessResolver *resolver)
        : QAtomicPointer(resolver)
    {}
...
class QPointerLazinessResolverFieldImmutable : public QPointerLazinessResolverField
{
    typedef QPointerLazinessResolverField super;
public:
    inline QPointerLazinessResolverFieldImmutable()
        : super(&QPointerLazinessResolver::globalImmutable)
    {}

    inline explicit QPointerLazinessResolverFieldImmutable(QPointerLazinessResolver *resolver)
        : super(resolver)
    {}
};
