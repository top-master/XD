...
#if defined(Q_CC_MSVC) && Q_CC_MSVC <= 1699
#  define Q_DECL_OVERRIDE_DEL
#  define Q_DECL_OVERRIDE_IL
#else
#  define Q_DECL_OVERRIDE_DEL Q_DECL_OVERRIDE
#  define Q_DECL_OVERRIDE_IL Q_DECL_OVERRIDE
#endif
...
#  define QT_WARNING_DISABLE_MSVC_5245 QT_WARNING_DISABLE_MSVC(5245)
#else
#  define QT_WARNING_DISABLE_MSVC_5245
#endif
