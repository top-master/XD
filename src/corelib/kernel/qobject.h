...
public:
    ...
    QPointerLazinessResolverFieldImmutable lazinessResolver;
...
inline QPointerLazinessResolverField &QScopedPointerLazyBase<QObjectData>::lazinessResolver() const {
    return static_cast<QObjectData *>(const_cast<Self *>(this)->d)->lazinessResolver;
}
